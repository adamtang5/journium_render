const BookmarksSolidIcon = ({ fill }) => {
    return (
        <svg stroke="currentColor" fill={fill || "#000"} stroke-width="0" viewBox="0 0 512 512" height="24px" width="24px" xmlns="http://www.w3.org/2000/svg">
...
export default BookmarksSolidIcon;
